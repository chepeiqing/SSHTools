...
export interface ElectronAPI {
  ...
  sftpDiscardTransfer: (id: string, type: 'upload' | 'download', localPath: string, remotePath: string) => Promise<{ success: boolean; error?: string }>
  ...
  // 跨窗口标签迁移
  tabDragHoverStart: (tabName: string) => Promise<void>
